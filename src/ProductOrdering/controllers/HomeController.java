...
public class HomeController {
    ...
    public void initialize(){
        ...
        ObservableList<Order> tableOrderList = FXCollections.observableArrayList(tableOrders); //from line 56
        ...
        addressCol.setCellValueFactory(new PropertyValueFactory<Order, String>("deliveryAddress")); //corresponding to the method in Order.java
        ...
        pendingOrderTable.setItems(tableOrderList); //from line 60
            ...
            public void handle(MouseEvent mouseEvent) {
                try {
                    if (mouseEvent.isPrimaryButtonDown()) {
                        System.out.println(selectionModel.getSelectedItem().getCustomerName()); //selectionModel from line 76
